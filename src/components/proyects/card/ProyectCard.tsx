          ...
          {card.linkProyect !== '' ? (
            <a href={card.linkProyect} target='_blank'>
              <button className='btnLinks'>
                <img
                  src='data:image/png;base64,'
                  alt='Proyect link'
                  width={20}
                  height={20}
                />
